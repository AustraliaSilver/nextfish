...
constexpr std::string_view version = "Nextfish v63 (Singularity Reborn)";
...
std::string engine_info(bool to_uci) {
    if (to_uci)
        return engine_version_info() + "\nid author the Stockfish developers & Nextfish Strategy module";

    return "\033[1m\033[93m" + engine_version_info() + "\033[0m by \033[96mNextfish Strategy module\033[0m";
}
